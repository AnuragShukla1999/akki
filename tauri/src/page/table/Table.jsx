...
//     return <Button label="Export" icon="pi pi-upload" className="button-help" onClick={exportCSV} />;
//   };
...
//     <>
//       <Button label="Cancel" icon="pi pi-times" outlined className="button-danger" onClick={hideDialog} />
//       <Button label="Save" icon="pi pi-check" className="button-success" onClick={saveEditProduct} />
//     </>
//   );

//   const deleteProductDialogFooter = (
//     <>
//       <Button label="No" icon="pi pi-times" outlined className="button-danger" onClick={hideDeleteProductDialog} />
//       <Button label="Yes" icon="pi pi-check" className="button-danger" onClick={deleteProduct} />
//     </>
//   );

//   const deleteProductsDialogFooter = (
//     <>
//       <Button label="No" icon="pi pi-times" outlined className="button-danger" onClick={hideDeleteProductsDialog} />
//       <Button label="Yes" icon="pi pi-check" className="button-danger" onClick={deleteSelectedOrAllProducts} />
//     </>
//   );
...
//         <Toolbar className="toolbar" left={leftToolbarTemplate} right={rightToolbarTemplate}></Toolbar>
...
//           <Column field="orderId" header="Order ID" sortable className='column'></Column>
//           <Column field="productName" header="Product Name" className='column'></Column>
//           <Column field="orderValue" header="Order Value" sortable className='column'></Column>
//           <Column field="fullName" header="Customer Details" sortable className='column'></Column>
//           <Column field="physicalWeight" header="Billable Weight" sortable className='column'></Column>
//           <Column exportable={false} className='column'></Column>
//         </DataTable>
//       </div>
